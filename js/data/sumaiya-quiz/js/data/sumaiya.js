...
var sumaiya={
	"problem121":function problem121(){
	var inputData = [{
		'd1':240,
		'ta': 24,
		'd2':650
	...
	"problem122":function problem122(){
	var inputData = [{
		'cp': 5000,
		'loss': 10
		},
	...
	"problem123":function problem123(){
	var inputData = [{
	...
	"problem124":function problem124(){
	var inputData = [{
	...
	"problem125":function problem125(){
	var inputData = [{
		'cp': 2000,
		'p': 25
		},
	...
	"problem126":function problem126(){
	var inputData = [{
		'sp': 2000,
		'loss': 20
		},
	...
	"problem127":function problem127(){
	var inputData = [
		{
		'distance':20,
		'speed': 400
	...
	"problem128":function problem128(){
	var inputData = [{
		'time':2,
		'speed':20
		},
	...
	"problem129":function problem129(){
	var inputData = [{
		'distance':68,
		'speeda': 13,
		'speedb':4
