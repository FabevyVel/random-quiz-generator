...
function problem091(){
	...
	question = {
		'type': 'single',
		'id': '091',
		'question': 'A car travells a distance ' + distance + 'km at ' + time + ' sec. Calculate the speed of the car.',
		'options': {
			'A': speed,
...
function problem0934(){
	...
	question = {
		'type': 'single',
		'id': '0934',
		'question': 'A man sold his bike for rs. ' + sp + '. If costPrice of article is ' + cp + '. Find the ' + pp + 'profit percentage?', 
		'options': {
			'A': pp,
			'B': pp * parseInt(Math.random()*10),
			'C': pp + parseInt(Math.random()*10),
